...
(()=>{
    const e = new Error("Cannot find module '@genkit-ai/flow'");
...
(()=>{
    const e = new Error("Cannot find module 'genkitx-googleai'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
;
;
const summarizeWebsiteTerms = defineFlow({
...
//# sourceMappingURL=src_76b692fc._.js.map